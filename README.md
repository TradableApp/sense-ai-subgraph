...
[![CI](https://img.shields.io/github/actions/workflow/status/TradableApp/sense-ai-subgraph/ci.yml?branch=main&label=CI)](https://github.com/TradableApp/sense-ai-subgraph/actions/workflows/ci.yml)
